 ...
 */
public class FoTableHeader extends FOPageSeqNode {
    ...
    /**
     * Construct an fo:table-header node, and build the
     * fo:table-header subtree.
     * <p>Content model for fo:table-header
    ...
    {
        super(foTree, FObjectNames.TABLE_HEADER, pageSequence, parent, event,
            ...
            if (numRows > 0) {
                ...
                if (numCells == 0)
                    throw new FOPException
                            ("No table-row or table-cell in table-header.");
