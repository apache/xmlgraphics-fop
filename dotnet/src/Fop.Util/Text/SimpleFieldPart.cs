...
/// <summary>
/// A simple field reference (<c>{fieldName}</c>). Port of the nested
/// <c>AdvancedMessageFormat.SimpleFieldPart</c>.
/// </summary>
internal sealed class SimpleFieldPart(string fieldName) : IPart
{
