...
/// <summary>
/// A function reference (<c>{#functionName}</c>). Port of the nested
/// <c>AdvancedMessageFormat.FunctionPart</c>.
/// </summary>
internal sealed class FunctionPart : IPart
{
    private readonly IFunction function;

    public FunctionPart(string functionName)
    {
        function = AdvancedMessageFormat.GetFunction(functionName)
    ...
    {
        object? obj = function.Evaluate(parameters);
