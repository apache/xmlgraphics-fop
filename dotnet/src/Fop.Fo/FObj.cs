...
public abstract class FObj : FONode
{
    ...
    /// <summary>The resolved <c>text-decoration</c> state (active lines and their colours).</summary>
    public TextDecorationTraits TextDecorationTraits => Properties.TextDecorationTraits;
