...
import org.apache.fop.activity.Executable;
...
public class FOPTestbed
    ...
    private static final Log logger = LogFactory.getLog(FOPTestbed.class);
    ...
    private class TaskRunner implements Runnable {
        ...
        public void run() {
            try {
                ...
                logger.error("Thread ended with an exception", e);
            }
        }
